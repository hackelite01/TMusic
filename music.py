...
def Exit():
	...
	print '          \t Created By HackElite'
	os.system("echo -e \"\e[1;31m\"")
	os.system("toilet -f mono12 -F border     HackElite   ")
	os.system("echo -e \"\e[1;32m\"")
	os.system('echo -e "\\e[1;34m Created By HackElite\\e[0m"')
	os.system('echo -e "\\e[4;32m This Player Was Created By HackElite \\e[0m"')
	os.system('echo -e "\\e[1;34m For Any Queries Msg Me!!!\\e[0m"')
	os.system('echo -e "\\e[1;32m          Telegram : t.me/mayank_Ka_B_For_Bor \\e[0m"')
	os.system('echo -e "\\e[1;31m       Channel: T.me/hackelite01 \\e[0m"')
	os.system('echo -e "\\e[1;33m   YouTube Page: https://youtube.com/channel/UCctC7DrSBTHcc8R-BrB9qRg \\e[0m"')
	exit()
...
while n < len(p):
	...
	os.system('clear')
	os.system("echo -e \"\e[1;31m\"")
	os.system("toilet -f mono12 -F border     TMusic
	os.system("echo -e \"\e[1;33m\"")
	os.system("printf \"%${COLUMNS}s\\n\" \"Created By HackElite      \"")
	os.system("echo -e \"\e[1;32m\"")
	os.system('echo ')
